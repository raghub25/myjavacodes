...
//Bob is a wall painter and he needs your help. You have to write a program that helps Bob calculate how many buckets of paint he 
//needs to buy before going to work. Bob might also have some extra buckets at home. He also knows the area that he can cover with 
//one bucket of paint.
...
public class PaintJob {
	...
	public static int getBucketCount(double area, double areaPerBucket) {
		if (area > 0 && areaPerBucket > 0) {
			return (int) Math.ceil(getBucketCount(area, 1, areaPerBucket));
		}
		return -1;
	}
}
