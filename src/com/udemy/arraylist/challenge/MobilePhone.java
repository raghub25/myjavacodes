...
//        updated with the new contact) and returns a boolean. Returns true if the contact exists and was updated successfully,
//        or false if the contact doesn't exists.
//
//        removeContact(), has one parameter of type Contact and returns a boolean. Returns true if the contact exists and was removed
//        successfully, or false if the contact doesn't exists.
//
//        findContact(), has one parameter of type Contact and returns an int. The returned value is it's position in the ArrayList,
...
//
//        ll methods should be defined as public (except for the two findContact() methods which are private).
//
//        Do not add a main method to the solution code.
//
//        If you get an error from the Evaluate class, it's most likely the constructor. Check if you've added a constructor or
//        if the constructor has the right arguments.
