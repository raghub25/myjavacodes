...
//
//Therefore, the sum of the kilos of bigCount and smallCount must be at least equal to the value of 
//goal. 
...
//each big bag is 5 kilos 
//and cannot be divided. However, if goal = 9, bigCount = 1, and smallCount = 5, 
